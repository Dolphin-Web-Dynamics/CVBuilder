...
export default function OpeningCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setFull_job_description(initialValues.full_job_description);
    setApplied(initialValues.applied);
    setSubmission_date(initialValues.submission_date);
    setResponse_date(initialValues.response_date);
